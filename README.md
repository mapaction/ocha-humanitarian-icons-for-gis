...
<img src="https://www.unocha.org/sites/unocha/files/icons_banner_2_1.jpg" alt="Humanitarian Icons" width="400px"style="float: right" > These icons were created by The United Nations Office for the Coordination of Humanitarian affairs (OCHA). MapAction has supported in the creation of the various GIS ready formats for ArcGIS and QGIS.
